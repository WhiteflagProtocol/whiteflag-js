 ...
 */
export { deepCopy, objHas, objHasNot, objToJson, objToMap, objToB64, objToB64u, objToU8a, jsonToObj, jsonToMap, mapToObj, mapToJson, mapToU8a, b64ToObj, b64uToObj, u8aToObj, u8aToMap };
 ...
 */
declare function objHas(obj: object, key: string): boolean;
/**
 ...
 * @throws if first argument is not an object
 */
declare function objHasNot(obj: object, key: string): boolean;
/**
