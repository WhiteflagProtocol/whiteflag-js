...
/* Dependencies */
import { ByteArray, objHasNot } from '@whiteflagprotocol/util';
...
async function generateSignKeyPair(algorithm = SignAlgorithm.ES256,
    ...
    if (objHasNot(keyPair, 'privateKey')) throw new TypeError('Generated key pair is missing private key');
    if (objHasNot(keyPair, 'publicKey')) throw new TypeError('Generated key pair is missing public key');
