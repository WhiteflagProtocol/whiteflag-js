...
import { ExtCryptoKey, createKeypair } from "./keys.js";
const ECDHALG = 'ECDH';
...
async function generateEcdhKeypair() {
    ...
    return createKeypair(new ExtCryptoKey(hexToU8a(rawPrivateKey), 'private', ecdhAlgorithm, ["deriveBits", "deriveKey"]), new ExtCryptoKey(hexToU8a(rawPublicKey), 'public', ecdhAlgorithm, ["deriveBits", "deriveKey"]));
}
