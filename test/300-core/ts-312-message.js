...
/* Test data */
import testVector from './data/tv-312-message.json' with { type: 'json' };
const dummychain = new Blockchain();

/* TEST SCRIPT */
testCase('Test case 312: Core message module', function() {
    ...
    testCase('Message serialisation', function() {
        assertion(' 2a. should correctly serialise (test vector 1)', async function() {
            const MSG = await WfCoreMessage.fromObject(testVector['1'].wfMessage);
            return strictEqual(MSG.toString(), testVector['1'].concatinatedMessage);
        });
        assertion(' 2b. should correctly serialise (test vector 2)', async function() {
        ...
        assertion(' 2c. should correctly serialise (test vector 3)', async function() {
        ...
        assertion(' 2d. should correctly serialise (test vector 4)', async function() {
    ...
    testCase('Message encryption', function() {
        ...
        assertion(' 5b. should correctly encrypt plain message object', async function() {
            const ACCOUNT = await Account.fromAddress(dummychain, testVector['5'].originatorAddress);
