...
testCase('Test case 130: Util binary buffer module', function() {
    testCase('Binary manupulation functions', function() {
        assertion(' 1. should correctly crop bits of UInt8Array', function(done) {
            ...
            strictEqual(u8aToHex(C1), testVector['1'].crop.hex);
            const C2 = cropBits(hexToU8a(testVector['1'].hex), testVector['1'].crop.nBits);
            strictEqual(u8aToHex(C1), u8aToHex(C2));
            return done();
        });
        assertion(' 2. should correctly right shift bits of UInt8Array', function(done) {
            ...
            strictEqual(u8aToHex(R), testVector['1'].shift.right.hex);
        ...
        assertion(' 3. should correctly left shift bits of UInt8Array', function(done) {
            const L = shiftLeft(hexToU8a(testVector['1'].hex), testVector['1'].shift.nBits);
            strictEqual(u8aToHex(L), testVector['1'].shift.left.hex);
            const R = shiftRight(hexToU8a(testVector['1'].hex), -(testVector['1'].shift.nBits));
            deepStrictEqual(R, L);
            return done();
        });
    ...
    testCase('Binary buffer class', function() {
        assertion(' 2a. should correctly create binary buffer from UInt8Array', function(done) {
            ...
            strictEqual(buffer.toHex(), testVector['1'].crop.hex);
            strictEqual(buffer.length, testVector['1'].bitLength);
            return done();
        });
        assertion(' 2b. should correctly create binary buffer from hexadecimal string', function(done) {
            ...
            strictEqual(buffer.toHex(), testVector['2'].hex);
            strictEqual(buffer.length, testVector['2'].bitLength);
            return done();
        });
        assertion(' 3a. should correctly append, insert and shift data', function(done) {
            ...
            strictEqual(A.length, testVector['3'].bitLength1);
            A.appendHex(testVector['3'].hex2, testVector['3'].bitLength2);
            strictEqual(A.toHex(), testVector['3'].append.hex);
            strictEqual(A.length, testVector['3'].append.bitLength);
            ...
            strictEqual(I.toHex(), testVector['3'].insert.hex);
            strictEqual(I.length, testVector['3'].insert.bitLength);

            /* Shift */
            strictEqual(I.shiftRight(testVector['3'].shift.nBits).toHex(), testVector['3'].shift.right.hex);
            strictEqual(I.shiftRight(-testVector['3'].shift.nBits).toHex(), testVector['3'].insert.hex);
            strictEqual(I.shiftLeft(testVector['3'].shift.nBits).toHex(), testVector['3'].shift.left.hex);
        ...
        assertion(' 3b. should correctly append and insert data (test vector 4)', function(done) {
            ...
            strictEqual(A.length, testVector['4'].bitLength1);
            A.appendHex(testVector['4'].hex2);
            strictEqual(A.toHex(), testVector['4'].append.hex);
            strictEqual(A.length, testVector['4'].append.bitLength);
            return done();
        });
        assertion(' 3c. should correctly append and insert data (test vector 5)', function(done) {
            ...
            strictEqual(A.length, testVector['5'].bitLength1);
            A.appendHex(testVector['5'].hex2);
            strictEqual(A.toHex(), testVector['5'].append.hex);
            strictEqual(A.length, testVector['5'].append.bitLength);
            return done();
        });
        assertion(' 4a. should correctly extract bits (test vector 3)', function(done) {
            ...
            strictEqual(extract, testVector['3'].extract.hex);
            return done();
        });
        assertion(' 4b. should correctly extract bits (test vector 4)', function(done) {
            ...
            strictEqual(extract, testVector['4'].extract.hex);
            return done();
        });
        assertion(' 4c. should correctly extract bits (test vector 5)', function(done) {
            ...
            strictEqual(extract, testVector['5'].extract.hex);
            return done();
        });
    });
})
